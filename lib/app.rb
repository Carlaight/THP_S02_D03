...
# tweet.update('Ça tweet en ruby au calme! #Bonjour_Monde! @the_hacking_pro')
...
#RECHERCHE DE TWEET
# def recherche_de_tweet(client)
#   client.search("#bonjour_monde", result_type: "recent").take(25).each do |tweet|
#   puts "#{tweet.user.screen_name}: #{tweet.text}"
#   end
# end

# recherche_de_tweet(login_twitter)

#RECHERCHE PUIS LIKE DE TWEET
# def recherche_tweet_like(client)
#   client.search("#bonjour_monde", result_type: "recent").take(20).each do |tweet|
#     client.fav tweet
#     end
#   end
  
# recherche_tweet_like(login_twitter)


# RECHERCHE PUIS FOLLOW DE TWEET
# def recherche_tweet_follow(client)
#   client.search("#bonjour_monde", result_type: "recent").take(20).each do |tweet|
#     client.follow tweet.user
#     end
#   end
  
# recherche_tweet_follow(login_twitter)

# RECHERCHE continu PUIS FOLLOW et like DE TWEET
def recherche_stream_tweet_follow_like(client)
  client.search("#bonjour_monde", result_type: "recent").take(20).each do |tweet|
    client.follow tweet.user
    end
  end
  
recherche_stream_tweet_follow_like(login_twitter)
